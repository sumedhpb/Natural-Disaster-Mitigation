...
{
	$query2=pg_query($conn,"Select * from my_status where rating='5'");
	while($row= pg_fetch_row($query2))
	{ 
		
	?>
    <script>
     locations.push([<?php echo $row[0];?>,<?php echo $row[1];?>]);
      </script>
	<?php
	}
}
?>
  ...
  <div style="width:900px;height:400px;position:relative;left:5%;" id="map"></div>
    ...
    <script>
      ...
      //image = "https://github.com/sumedhpb/Natural-Disaster-Mitigation/blob/master/screenshots/danger2.png"
